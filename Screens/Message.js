...
const Message = (props) => {
  ...
  const drID = props.route.params.id;
    ...
    setMessages([
      {
        ...
        user: {
          _id: userId,
          name: {name},
          avatar: 'https://placeimg.com/140/140/doctor',
        },
      },
    ]);
  }, []);
...
//                 <Text>This is Chat section</Text>
//             </View >
//         )
//     }
//     const Call = () => {
//         return (
//             <View>
//                 <Text>This is call section</Text>
...
//                 <View style={styles.header}>
//                     <Text style={{ marginBottom: 30, fontSize: 26, fontWeight: '600', color: 'white' }}>Consult Doctor</Text>
//                 </View>
